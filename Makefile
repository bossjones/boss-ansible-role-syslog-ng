...
URL_PATH_NETDATA_REGISTRY  := "http://syslog-ng-master-01.$(DNSMASQ_DOMAIN):19999"
URL_PATH_NETDATA_NODE      := "http://syslog-ng-worker-01.$(DNSMASQ_DOMAIN):19999"
...
ssh-bridge-master:
	ssh -vvvv -F ./ssh_config syslog-ng-master-01.scarlettlab.home

ssh-bridge-worker:
	ssh -vvvv -F ./ssh_config syslog-ng-worker-01.scarlettlab.home
